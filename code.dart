...
class DynamicIconRenderer extends StatefulWidget {
  ...
  final double tamanho; // Corrigido para double

  @override
  State<DynamicIconRenderer> createState() => _DynamicIconRendererState();
}

class _DynamicIconRendererState extends State<DynamicIconRenderer> {
  @override
  Widget build(BuildContext context) {
    ...
    // Obtém o ícone correspondente ou um ícone padrão
    final IconData dynamicIcon = iconMap[widget.iconName] ?? Icons.menu_book;

    // Renderiza o ícone com a cor e tamanho passados como parâmetros
    return Container(
      width: widget.width,
      height: widget.height,
      child: Icon(dynamicIcon, size: widget.tamanho, color: widget.corIcone),
    );
  }
}
